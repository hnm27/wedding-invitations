/* ============================================================
   HUMAID & SHUMAILA — Walima invitation
   Behaviour: envelope reveal, scroll reveals, ambient particles
   and the countdown to the Walima.
...
(function(){
  ...
  /* ---- the one date everything counts toward -------------
     Walima — 3 January 2027, 8pm, Kolkata (IST, UTC+05:30),
     matching the time printed on the card. This card invites
     guests to the Walima only, so the clock counts to that
     rather than to the Baraat two days earlier.
     The Nikah itself was on 31 May 2026.                     */
  var TARGET = new Date('2027-01-03T20:00:00+05:30');
